...
export interface GitHubPopoverProps {
  profile: SocialProfile;
  locale?: string | undefined;
  className?: string | undefined;
}

export function GitHubPopover({ profile, locale, className }: GitHubPopoverProps) {
  ...
  const title = t("social.github.title") || "GitHub Profile";
  const description =
    t("social.github.description") ||
    profile.description ||
        ...
        >
          <EditableRegion
            editableRef={{
              ...
              entityId: profile.id,
              fieldOrBlockId: "github_profile",
              locale: locale === "en" ? "en" : "ar",
              title: "GitHub Profile Settings",
              initialData: {
                url: profile.url,
          ...
          >
            <div className="space-y-4">
              ...
              <div aria-live="polite" className="sr-only">
                {isCopied ? "GitHub URL copied to clipboard" : ""}
              </div>
            </div>
          </EditableRegion>
        </div>
